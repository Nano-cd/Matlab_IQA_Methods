function  [mu_prisparam cov_prisparam]  = estimatemodelparam(folderpath,...
    blocksizerow,blocksizecol,blockrowoverlap,blockcoloverlap,sh_th, i)
...
for itr = 1:length(folderpath)
itr
img = folderpath(itr);
im               = imread(['D:\chengdi\iqa_matlab\Comp_Methods\endo', '\', char(img{1})]);
im = imresize(im,0.5);
...
save(['modelparameters_new',num2str(i),'.mat'],'mu_prisparam','cov_prisparam');
%----------------------------------------------
